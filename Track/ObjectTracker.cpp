...
//
//bool ObjectTracker::StartTracking(rgb_pixel imageRgb[], int width, int height, int roiX, int roiY, int roiW, int roiH)
//{
//	bool success = true;
//
...
//
//
//bool ObjectTracker::Update(rgb_pixel imageRgb[], int width, int height, int* pX, int* pY, int* pW, int* pH)
//{
//	bool success = true;
//
//	dlib::matrix<rgb_pixel> matrix = mat(imageRgb, height, width, width);
